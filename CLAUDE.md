...
micro-squad is a drop-in multi-agent sprint system for Claude Code and GitHub Copilot. It coordinates sub-agents through think, plan, build, verify, and ship phases using only Markdown skill files and each assistant's native agent support.
